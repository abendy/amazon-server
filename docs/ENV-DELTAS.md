...
| AMPAS | local | `ampas.local` | HTTP `80` | `/var/www/html/amazon-studios-ampas/web` | Not applicable | `127.0.0.1:9071` validation placeholder; no local WP pool exists | Off | `/var/log/nginx/ampas-access.log` / `/var/log/nginx/ampas-error.log` |
...
| Guilds | local | `guilds.local` | HTTP `80` | `/var/www/html/amazon-studios-guilds/web` | Not applicable | `127.0.0.1:9072` validation placeholder; no local WP pool exists | Off | `/var/log/nginx/guilds-access.log` / `/var/log/nginx/guilds-error.log` |
